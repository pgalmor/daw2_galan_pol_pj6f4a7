...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="https://laptop-q7tn42mh/pj6/eCommerce/app/cli/images/logo.ico">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB" crossorigin="anonymous">
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js" integrity="sha384-FKyoEForCGlyvwx9Hj09JcYn3nv7wiPVlz7YYwJrWVcXK/BmnVDxM+D2scQbITxI" crossorigin="anonymous"></script>
    <link href="https://laptop-q7tn42mh/pj6/eCommerce/app/cli/style.css" rel="stylesheet">
</head>
<body>
    <div class="body-container">
        <div class="d-flex align-items-center justify-content-center mb-4">
            <img src="https://laptop-q7tn42mh/pj6/eCommerce/app/cli/images/logo.png" alt="Logo" class="me-3" style="width: 60px; height: 60px;">
        ...
        <div class="btn-group-custom">
            <a class="btn btn-custom" href="https://laptop-q7tn42mh/pj6/eCommerce/app/cli/menu.html">Menu</a>
            <a class="btn btn-custom" href="https://laptop-q7tn42mh/pj6/eCommerce/app/cli/index.html">Home</a>
        </div>
    </div>
</body>
</html>